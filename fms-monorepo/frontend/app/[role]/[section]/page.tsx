...
const sections = new Set<DashboardView>(["cash-advances", "expenses", "approvals", "ledger", "branches", "reports", "audit"]);
...
export default function Page({ params }: { params: { role: string; section: string } }) {
  ...
  if (!role || !sections.has(section) || (section === "audit" && role !== "AUDITOR" && role !== "FINANCE_HEAD")) notFound();
